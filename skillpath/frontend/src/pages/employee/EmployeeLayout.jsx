...
const navItems = [
  ...
  { to: '/employee/learning-path', icon: Target, label: 'O\'quv yo\'li' },
  { to: '/employee/trainings', icon: BookOpen, label: 'Traininglarim' },
  { to: '/employee/profile', icon: User, label: 'Profilim' },
];
      ...
      <aside className="sidebar">
        <div className="sidebar-logo">
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
            <div style={{ width: 32, height: 32, borderRadius: 8, background: 'rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, fontWeight: 700, color: 'white' }}>S</div>
            <h1 style={{ fontFamily: 'Sora,sans-serif', fontSize: 18, fontWeight: 700, color: 'white' }}>SkillPath</h1>
          </div>
          <span style={{ fontSize: 10.5, color: 'var(--blue-300)', letterSpacing: 1 }}>XODIM PORTALI</span>
        </div>
        ...
        <div style={{ marginTop: 'auto', padding: 12, borderTop: '1px solid rgba(255,255,255,0.08)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 12px', borderRadius: 10, background: 'rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 10.5, color: 'var(--blue-300)' }}>Xodim</div>
            </div>
            <button onClick={async () => { await logout(); navigate('/login'); }} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.5)', padding: 4 }}><LogOut size={16} /></button>
          </div>
        </div>
      </aside>
